...
export const metadata: Metadata = {
  ...
  description: "How Babytuna Systems handles information.",
};
...
export default function PrivacyPage() {
  return (
    <LegalPage title="Privacy Policy">
      <p>
        This Policy explains how Babytuna Systems handles information through
        its mobile app, web pages, and related services (the “Service”).
        Babytuna Systems is operated by the developer identified on its App
        Store listing (“Babytuna,” “we,” “us,” or “our”). The Service is for
        authorized restaurant teams, not general consumer use.
      </p>
      ...
      <LegalSection title="1. Who controls workplace information">
        <p>
          ...
          Babytuna processes it to provide the Service. Managers may view and
      ...
      <LegalSection title="11. Changes and contact">
        ...
        <p>
          ...
          through the Babytuna Systems App Store listing or website.
        </p>
      </LegalSection>
    </LegalPage>
  );
