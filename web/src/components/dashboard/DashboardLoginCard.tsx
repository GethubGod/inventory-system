...
// Dashboard-local sign-in card. Mirrors the tips manager LoginCard idiom but
// is deliberately a separate component (Phase 2 contract: no imports from
// components/manager/*).
...
export default function DashboardLoginCard() {
  ...
  async function onSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    // On success DashboardGate's onAuthStateChange takes over.
  }
