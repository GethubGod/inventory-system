...
export default function VoiceScreen() {
  ...
  const processOfflineQueue = useTunaSpecialistStore(
    (s) => s.processOfflineQueue,
  );
  const removeCartItem = useTunaSpecialistStore((s) => s.removeCartItem);
  const updateCartItemQuantity = useTunaSpecialistStore(
    (s) => s.updateCartItemQuantity,
  );
  ...
  // Visualizer state
  const vizState: "idle" | "listening" | "processing" | "speaking" = isListening
    ? "listening"
    : isProcessing
      ? "processing"
      : currentSpeaker === "ai"
  ...
  const lastHumanMsg = [...conversation]
    .reverse()
    .find((m) => m.type === "human");
      ...
      <SafeAreaView style={{ flex: 1, backgroundColor: "#F9FAFB" }}>
        ...
        >
          <View style={{ width: "100%", maxWidth: 560, alignItems: "center" }}>
            ...
            >
              Your AI-powered voice ordering assistant. Speak naturally in
              English or Chinese — Tuna Specialist figures out the rest.
            </Text>
            ...
            >
              {[
                ...
                {
                  Icon: MessageSquare,
                  text: "AI that remembers your past orders",
                },
    ...
    <View style={{ flex: 1, backgroundColor: "#0A0A0F" }}>
      <LinearGradient colors={["#0A0A0F", "#111827"]} style={{ flex: 1 }}>
        ...
        >
          ...
          {isIdle && (
            <View
              style={{ alignItems: "center", marginBottom: ds.spacing(20) }}
            >
          ...
          >
              ...
              <View style={{ alignItems: "center" }}>
                ...
                <Text
                  style={{
                    fontSize: ds.fontSize(12),
                    color:
                      recordingSeconds >= WARN_SECONDS ? "#FBBF24" : "#EF4444",
                    marginTop: ds.spacing(8),
                    textAlign: "center",
                  }}
                >
                  0:{String(recordingSeconds).padStart(2, "0")}
                  {recordingSeconds >= WARN_SECONDS &&
                    ` — auto-stop in ${MAX_SECONDS - recordingSeconds}s`}
                </Text>
              </View>
            )}
            ...
            {isProcessing && (
              <View style={{ alignItems: "center" }}>
                ...
                <Text style={{ fontSize: ds.fontSize(13), color: "#F97316" }}>
                  Thinking...
                </Text>
              </View>
            )}
              ...
              <View style={{ alignItems: "center", maxWidth: "100%" }}>
                ...
                {lastAiParsed && lastAiParsed.length > 0 && (
                  ...
                  >
                    ...
                    {lastAiParsed
                      .map(
                        (it) => `${it.emoji} ${it.item_name} ×${it.quantity}`,
                      )
                      .join(", ")}
                  </Text>
                )}
        ...
        <View style={{ alignItems: "center", paddingVertical: ds.spacing(16) }}>
          <Animated.View
            style={{ transform: [{ scale: isListening ? micPulseAnim : 1 }] }}
          >
            {/* Pulse ring */}
            {isListening && (
              <Animated.View
            ...
            <>
              ...
              >
                ...
                {conversation.length > 2 && (
                  ...
                  >
                    <Text
                      style={{ fontSize: ds.fontSize(11), color: "#64748B" }}
                    >
                      History
                    </Text>
                  </TouchableOpacity>
              ...
              {/* Cart items */}
              <ScrollView
                style={{ maxHeight: 200, paddingHorizontal: ds.spacing(16) }}
                showsVerticalScrollIndicator={false}
              >
                  ...
                  >
                    ...
                    >
                      ...
                      <View style={{ flex: 1 }}>
                        ...
                        {item.spoken_text &&
                          item.spoken_text !== item.item_name && (
                            <Text
                              style={{
                                fontSize: ds.fontSize(10),
                                color: "#4B5563",
                    ...
                    >
                      <TouchableOpacity
                        ...
                        style={{
                          width: Math.max(44, ds.icon(30)),
                          height: Math.max(44, ds.icon(30)),
                          borderRadius: ds.radius(15),
                          backgroundColor: "rgba(255,255,255,0.08)",
                          alignItems: "center",
                          justifyContent: "center",
                        }}
              ...
              >
                ...
                <TouchableOpacity
                  ...
                  style={{
                    ...
                    height: ds.buttonH,
                    backgroundColor:
                      cartItems.length > 0 ? "#F97316" : "#374151",
                    borderRadius: ds.radius(14),
                    alignItems: "center",
                    justifyContent: "center",
                    shadowColor: "#F97316",
                ...
                >
                  ...
                  >
                    Save {cartItems.length} Item
                    {cartItems.length !== 1 ? "s" : ""} to Cart
                  </Text>
                </TouchableOpacity>
              </View>
            </>
                ...
                {[
                  {
                    ...
                    text: "Tap mic and say your order",
                  },
                  {
                    icon: "chatbubble-outline" as const,
                    text: "Ask questions or make changes",
                  },
                  {
                    icon: "cart-outline" as const,
                    text: "Review and save to your order cart",
                  },
                ].map((step) => (
                  <View
                    key={step.icon}
