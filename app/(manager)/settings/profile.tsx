    ...
    >
      <ManagerScaleContainer>
        ...
        <View style={{ flex: 1 }}>
          <SettingsSectionLabel
            label="Identity"
            description="Keep manager account details readable and aligned with the rest of the polished Babytuna app."
          />
          ...
          >
            ...
            <ProfileInfoRow
              ...
              value={locations.length ? `${locations.length} active locations` : 'No locations'}
                ...
                {locations.map((location, index) => (
                  <View
                    ...
                    style={{
                      ...
                      borderBottomWidth:
                        index < locations.length - 1 ? glassHairlineWidth : 0,
                      borderBottomColor: glassColors.divider,
                    }}
                  >
                    <View
                      style={{
                        width: Math.max(34, ds.icon(34)),
                        height: Math.max(34, ds.icon(34)),
                        borderRadius: glassRadii.iconTile,
                        alignItems: 'center',
                        justifyContent: 'center',
                        backgroundColor: glassColors.mediumFill,
