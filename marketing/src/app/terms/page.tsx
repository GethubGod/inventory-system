...
export const metadata: Metadata = {
  title: "Terms of Use | smelter",
  description: "Terms governing use of smelter.",
};

export default function TermsPage() {
  return (
    <LegalPage title="Terms of Use" effectiveDate="August 26, 2026">
      <p>
        These Terms govern smelter, including its mobile app, web pages, and
        related services (the “Service”). smelter is operated by the developer
        identified on its App Store listing (“smelter,” “we,” “us,” or “our”).
        By using the Service, you agree to these Terms. If an organization gave
        you access, you also agree to its rules. A separate written agreement
        with an organization controls if it conflicts with these Terms.
      </p>
      ...
      <LegalSection title="4. Permission and acceptable use">
        <p>
          ...
          right to use the Service for authorized workplace duties. smelter
      ...
      <LegalSection title="11. Limits on liability">
        <p>
          To the extent permitted by law, smelter and its providers will not
      ...
      <LegalSection title="14. Changes and contact">
        ...
        <p>
          ...
          smelter App Store listing or the support page on this site.
        </p>
      </LegalSection>
    </LegalPage>
  );
