// Starts the already-built web/ production server on :3100 with the public
// Supabase env inlined. The build must already exist (rebuild-and-start.mjs
// ran it with the same env baked in). Key is extracted in memory only.
