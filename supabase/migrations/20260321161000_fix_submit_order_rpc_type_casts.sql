-- Fix: cast unit_type text → unit_type enum, leave input_mode as text.
-- The previous version inserted raw text into the unit_type enum column,
-- causing: "column unit_type is of type unit_type but expression is of type text"
